...
exports.withToast = function (Component) { return function (props) { return (React.createElement(ToastContext.Consumer, null, function (other) { return React.createElement(Component, __assign({}, props, other)); })); }; };
