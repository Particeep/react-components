...
var Btn = /** @class */ (function (_super) {
    ...
    Btn.prototype.render = function () {
        var _a = this.props, loading = _a.loading, classes = _a.classes, children = _a.children, disabled = _a.disabled, icon = _a.icon, iconAfter = _a.iconAfter, props = __rest(_a, ["loading", "classes", "children", "disabled", "icon", "iconAfter"]);
