...
exports.SidebarFooter = core_1.withStyles(styles)(function (_a) {
    var children = _a.children, classes = _a.classes, className = _a.className;
    return (React.createElement("footer", { className: classnames_1.default(classes.root, className) }, children));
});
