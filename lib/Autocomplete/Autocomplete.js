...
var Autocomplete = /** @class */ (function (_super) {
    ...
    function Autocomplete() {
        ...
        _this.selectAll = function (event, checked) {
            var values = checked ? React.Children.map(_this.props.children, function (x) { return x.props.value; }) : [];
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(core_1.Menu, { anchorEl: anchorEl, open: !!anchorEl, onClose: this.close },
                React.createElement("header", { className: classnames_1.default(classes.menu_head, multiple && classes.menu_headWithCb) },
                    multiple &&
                        React.createElement(core_1.Checkbox, { checked: value.length === optionsCount, onChange: this.selectAll, indeterminate: value.length > 0 && value.length < optionsCount, disabled: readonly }),
                ...
                React.createElement("div", { className: classes.menu_items, style: { width: this.$input && this.$input.clientWidth } }, filteredChildren.map(function (x) {
                    return React.cloneElement(x, __assign({}, x.props, { multiple: multiple, checked: value.indexOf(x.props.value) !== -1, onClick: _this.handleChange }));
                })))));
    };
