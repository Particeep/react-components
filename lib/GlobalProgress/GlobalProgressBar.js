...
var GlobalProgressBar = function (_a) {
    var currentStep = _a.currentStep, steps = _a.steps, started = _a.started, classes = _a.classes, className = _a.className, style = _a.style, styleProgress = _a.styleProgress;
...
exports.default = core_1.withStyles(styles)(GlobalProgressContext_1.withGlobalProgress(GlobalProgressBar));
