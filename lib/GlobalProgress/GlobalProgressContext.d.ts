...
export declare const GlobalProgressContext: React.Context<IState>;
...
export declare const useGlobalProgress: () => WithProgress;
export declare const useGlobalProgressState: () => IProgressState;
