...
exports.useGlobalProgress = function () {
    var _a = react_1.useContext(exports.GlobalProgressContext), progressStart = _a.progressStart, progressStop = _a.progressStop, progressComplete = _a.progressComplete, progressNext = _a.progressNext, promisesWithProgress = _a.promisesWithProgress;
    return {
        progressStart: progressStart,
        progressStop: progressStop,
        progressComplete: progressComplete,
        progressNext: progressNext,
        promisesWithProgress: promisesWithProgress,
    };
};
exports.useGlobalProgressState = function () {
    var _a = react_1.useContext(exports.GlobalProgressContext), currentStep = _a.currentStep, steps = _a.steps, started = _a.started;
    return {
...
exports.withGlobalProgress = function (Component) { return function (props) { return (React.createElement(exports.GlobalProgressContext.Consumer, null, function (other /*WithProgress*/) { return React.createElement(Component, __assign({}, props, other)); })); }; };
