...
var Page = function (_a) {
    var classes = _a.classes, children = _a.children, width = _a.width, _b = _a.animated, animated = _b === void 0 ? true : _b, className = _a.className, style = _a.style;
...
exports.default = core_1.withStyles(styles)(Page);
